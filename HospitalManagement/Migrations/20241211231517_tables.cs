        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Assistants_Instructors_InstructorID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    shift = table.Column<string>(type: "nvarchar(20)", nullable: false),
                    IsAvailable = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_InstructorSchedules", x => x.InstructorScheduleId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AssistantScheduleId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    StartTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EndTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    AssistantID = table.Column<int>(type: "int", nullable: false),
                    ...
                    day = table.Column<string>(type: "nvarchar(20)", nullable: false),
                    shift = table.Column<string>(type: "nvarchar(20)", nullable: false),
                    timeConsuming = table.Column<int>(type: "int", nullable: false),
                    IsAvailable = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AssistantSchedules", x => x.AssistantScheduleId);
                    table.ForeignKey(
                        name: "FK_AssistantSchedules_Assistants_AssistantID",
                        column: x => x.AssistantID,
                        principalTable: "Assistants",
                        principalColumn: "AssistantID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AssistantSchedules_Departments_DepartmentID",
                        column: x => x.DepartmentID,
                        principalTable: "Departments",
                        principalColumn: "DepartmentID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Appointments_AssistantSchedules_AssistantScheduleId",
                        column: x => x.AssistantScheduleId,
                        principalTable: "AssistantSchedules",
                        principalColumn: "AssistantScheduleId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_AssistantScheduleId",
                table: "Appointments",
                column: "AssistantScheduleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Assistants_InstructorID",
                table: "Assistants",
                column: "InstructorID");

            migrationBuilder.CreateIndex(
                name: "IX_AssistantSchedules_AssistantID",
                table: "AssistantSchedules",
                column: "AssistantID");

            migrationBuilder.CreateIndex(
                name: "IX_AssistantSchedules_DepartmentID",
                table: "AssistantSchedules",
                column: "DepartmentID");
